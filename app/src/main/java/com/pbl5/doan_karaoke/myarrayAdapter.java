...
public class myarrayAdapter extends ArrayAdapter<Item> {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        //Xửlý hiển thị cho Image Button btnlike và btnunlike
        if(thich==0)
        {
            btnlike.setVisibility(View.INVISIBLE);
            //cho ẩn btnlike
            btnunlike.setVisibility(View.VISIBLE);
            //cho hiển thịbtnunlike
        } else
        {
        ...
        // Cập nhật trạng thái thich vào CSDL;
        // Thiết lập ImageButton cho phù hợp
        ...
        // Khai báo Intent, Bundle,lấy masotruyền qua subactivityvà gọi activitysub(activitysubxây dựng ởbước sau)
