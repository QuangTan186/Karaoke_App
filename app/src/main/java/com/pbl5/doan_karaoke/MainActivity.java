...
public class MainActivity extends AppCompatActivity{
    ...
    // Trên 3 Tab chúng ta có 3 ListView ứng với 3 Danh sách dữliệu (Dữliệu tìm kiếm, Danh
    ...
    public void CopyDataBaseFromAsset() {
        ...
        try{
            ...
            if(!f.exists())
                f.mkdir();
            //Open the empty dbas the output stream
            OutputStream myOutput = new FileOutputStream(outFileName);
            //transfer bytes from the inputfileto the outputfile
